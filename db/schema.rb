...
ActiveRecord::Schema.define(version: 20160306180121) do
  ...
  add_index "recruiters", ["confirmation_token"], name: "index_recruiters_on_confirmation_token", unique: true, using: :btree
